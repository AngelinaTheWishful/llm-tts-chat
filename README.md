...
> **v1.3.7 已发布**（2026-08-07）· [GitHub Releases](https://github.com/AngelinatheMellowWish/llm-tts-chat/releases)
...
- **会话重命名 + 语音命名规范**（v1.3.7）：侧栏「会话」可选中会话后输入新名一键重命名；语音文件命名带 角色名/会话名/合成时间/应用版本/消息版本（如 `暴行_暴行-1_20260807_153012_v1.3.7_m1.wav`），播放器旁可「下载当前语音」；统计面板点击即时可见
